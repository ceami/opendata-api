    ...
    async def get_std_doc_detail(self, *, list_id: int) -> dict[str, Any]:
        ...
        if api_document:
            ...
            return {
                ...
                "description": (
                    open_api_info.desc.replace("<br/>", "\n")
                    if (open_api_info and getattr(open_api_info, "desc", None))
                    else None
                ),
                ...
                "share_scope_nm": getattr(
                    open_api_info, "share_scope_nm", None
                ),
                "keywords": getattr(open_api_info, "keywords", [])
                if open_api_info
                else [],
        ...
        if file_document:
            ...
            return {
                ...
                "description": (
                    open_file_info.desc.replace("<br/>", "\n")
                    if (
                        open_file_info and getattr(open_file_info, "desc", None)
                    )
                    else None
                ),
                ...
                "share_scope_nm": getattr(
                    open_file_info, "share_scope_nm", None
                ),
                "keywords": getattr(open_file_info, "keywords", [])
                if open_file_info
                else [],
        ...
        if open_api_info:
            return {
                ...
                "description": (
                    open_api_info.desc.replace("<br/>", "\n")
                    if getattr(open_api_info, "desc", None)
                    else None
                ),
        ...
        if open_file_info:
            return {
                ...
                "description": (
                    open_file_info.desc.replace("<br/>", "\n")
                    if getattr(open_file_info, "desc", None)
                    else None
                ),
        ...
        raise ValueError(
            f"list_id {list_id}에 해당하는 데이터를 찾을 수 없습니다"
        )
